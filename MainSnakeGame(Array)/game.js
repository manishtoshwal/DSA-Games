...
function cnvRes(width = 500, height = 500) {
    ...
    update() {
        ...
        if (this.localDelay < 0) {
            if (this.type == "tail") {
                ...
                if (this.x + ctx.canvas.width / _vars.segments > ctx.canvas.width + ctx.canvas.width / _vars.segments) {
                    this.x = 0;
                }
                if (this.y + ctx.canvas.height / _vars.segments > ctx.canvas.width + ctx.canvas.width / _vars.segments) {
                    this.y = 0;
                }
                if (this.y < 0) {
